...
return (
  <Box className='content-center' sx={{ backgroundColor: 'white'}}>
    {!hidden ? (
      <Box
        sx={{
          height: '92vh', 
      ...
      <Box sx={{
        ...
        height: '100%',
        borderRadius: '6px',
        background:'url(/images/pages/Container1.png)',
        ...
        >
          ...
          <Box sx={{ my: 6 }}>           
            ...
            <Button fullWidth type='submit' variant='contained' 
              ...
              <img alt='yandex' src={`/images/pages/yandex.svg`}/>
                Войти по Яндекс ID
            </Button>
            ...
            <Button fullWidth type='submit' variant='contained' 
              ...
              <img alt='google' src={`/images/pages/google.svg`}/>
                Войти через Google
            </Button>
            ...
            <Button fullWidth type='submit' variant='contained' 
              ...
              <img alt='vk' src={`/images/pages/vk.svg`}/>
            ...
            <Button fullWidth type='submit' variant='contained' 
              ...
              <img alt='tinkoff' src={`/images/pages/tinkoff.svg`}/>
                Войти с Тинькофф
            </Button>
          </Box>
...
//         height: '100%',
//         borderRadius: '6px',
//         background:'url(/images/pages/Container.png)',
//         backgroundPosition:'center-center',
//         backgroundRepeat:'no-repeat',
//         backgroundSize:'cover',
//         position:'relative',
...
//                           >
//                           <Icon fontSize='1.25rem' color={showPassword ? 'rgba(234, 84, 85, 1)' : 'rgba(75, 70, 92, 1)'} icon={showPassword ? 'tabler:eye' : 'tabler:eye-off'} />
//                           </IconButton>
//                         </InputAdornment>
//                       )
//                     }}
...
//               <Typography sx={{ 
//                 color: 'var(--brand-bright-blue, #006CEF);', 
//                 mr: 2 , 
//                 fontWeight:'400', 
//                 fontSize:'15px'}}>
//                   Забыли пароль?
